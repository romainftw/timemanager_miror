...
const char* erts_build_flags_CFLAGS = "-Werror=undef -Werror=implicit -Werror=return-type  -fno-strict-aliasing -fno-common -g -O2 -I/home/narjes/document/epitech/timemanager/timemanagerback/otp_src_26.0/erts/x86_64-pc-linux-gnu    -D_GNU_SOURCE  -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wpointer-arith -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS   -DBEAMASM=1";
